...
class CosmosDBLoader():
    ...
    def __get_embeddings_client(self):
        """Build Azure OpenAI embeddings client from required environment variables."""
        ...
        if missing:
            ...
            raise ValueError(
                ...
                "Update your .env before running the loader."
            )
